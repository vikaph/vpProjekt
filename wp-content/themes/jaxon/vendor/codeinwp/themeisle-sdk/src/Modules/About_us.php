...
class About_Us extends Abstract_Module {
	...
	private function get_about_localization_data() {
		...
		return [
			...
			'strings'            => [
				'aboutUs'          => __( 'About us', 'jaxon' ),
				'heroHeader'       => __( 'Our Story', 'jaxon' ),
				'heroTextFirst'    => __( 'Themeisle was founded in 2012 by a group of passionate developers who wanted to create beautiful and functional WordPress themes and plugins. Since then, we have grown into a team of over 20 dedicated professionals who are committed to delivering the best possible products to our customers.', 'jaxon' ),
				'heroTextSecond'   => __( 'At Themeisle, we offer a wide range of WordPress themes and plugins that are designed to meet the needs of both beginners and advanced users. Our products are feature-rich, easy to use, and are designed to help you create beautiful and functional websites.', 'jaxon' ),
				'teamImageCaption' => __( 'Our team in WCEU2022 in Portugal', 'jaxon' ),
				'newsHeading'      => __( 'Stay connected for news & updates!', 'jaxon' ),
				'emailPlaceholder' => __( 'Your email address', 'jaxon' ),
				'signMeUp'         => __( 'Sign me up', 'jaxon' ),
				'installNow'       => __( 'Install Now', 'jaxon' ),
				'activate'         => __( 'Activate', 'jaxon' ),
				'learnMore'        => __( 'Learn More', 'jaxon' ),
				'installed'        => __( 'Installed', 'jaxon' ),
				'notInstalled'     => __( 'Not Installed', 'jaxon' ),
				'active'           => __( 'Active', 'jaxon' ),
			],
	...
	private function get_product_pages_data( $product_pages ) {
		...
		$pages = [
			'otter-page' => [
				...
				'plugin'  => $otter_plugin,
				'strings' => [
					'heading'      => __( 'Build innovative layouts with Otter Blocks and Gutenberg', 'jaxon' ),
					'text'         => __( 'Otter is a lightweight, dynamic collection of page building blocks and templates for the WordPress block editor.', 'jaxon' ),
					'buttons'      => [
						'install_otter_free' => __( "Install Otter - It's free!", 'jaxon' ),
						'install_now'        => __( 'Install Now', 'jaxon' ),
						'learn_more'         => __( 'Learn More', 'jaxon' ),
						'learn_more_link'    => tsdk_utmify( 'https://themeisle.com/plugins/otter-blocks/', 'otter-page', 'about-us' ),
					],
					'features'     => [
						'advancedTitle' => __( 'Advanced Features', 'jaxon' ),
						'advancedDesc'  => __( 'Add features such as Custom CSS, Animations & Visibility Conditions to all blocks.', 'jaxon' ),
						'fastTitle'     => __( 'Lightweight and Fast', 'jaxon' ),
						'fastDesc'      => __( 'Otter enhances WordPress site building experience without impacting site speed.', 'jaxon' ),
						'mobileTitle'   => __( 'Mobile-Friendly', 'jaxon' ),
						'mobileDesc'    => __( 'Each block can be tweaked to provide a consistent experience across all devices.', 'jaxon' ),
					],
					'details'      => [
						's1Image' => $this->get_sdk_uri() . 'assets/images/otter/otter-builder.png',
						's1Title' => __( 'A Better Page Building Experience', 'jaxon' ),
						's1Text'  => __( 'Otter can be used to build everything from a personal blog to an e-commerce site without losing the personal touch. Otter’s ease of use transforms basic blocks into expressive layouts in seconds.', 'jaxon' ),
						's2Image' => $this->get_sdk_uri() . 'assets/images/otter/otter-patterns.png',
						's2Title' => __( 'A New Collection of Patterns', 'jaxon' ),
						's2Text'  => __( 'A New Patterns Library, containing a range of different elements in a variety of styles to help you build great pages. All of your website’s most important areas are covered: headers, testimonials, pricing tables, sections and more.', 'jaxon' ),
						's3Image' => $this->get_sdk_uri() . 'assets/images/otter/otter-library.png',
						's3Title' => __( 'Advanced Blocks', 'jaxon' ),
						's3Text'  => __( 'Enhance your website’s design with powerful blocks, like the Add to Cart, Business Hours, Review Comparison, and dozens of WooCommerce blocks.', 'jaxon' ),
					],
					'testimonials' => [
						'heading' => __( 'Trusted by more than 300K website owners', 'jaxon' ),
						'users'   => [
							[
	...
	private function get_other_products_data() {
		$products = [
			...
			'neve'                                => [
				'skip_api'    => true,
				'name'        => 'Neve',
				'description' => __( 'A fast, lightweight, customizable WordPress theme offering responsive design, speed, and flexibility for various website types.', 'jaxon' ),
			...
			'wp-landing-kit'                      => [
				...
				'name'        => 'WP Landing Kit',
				'description' => __( 'Turn WordPress into a landing page powerhouse with Landing Kit, map domains to pages or any other published resource.', 'jaxon' ),
			...
			'sparks-for-woocommerce'              => [
				...
				'name'        => 'Sparks',
				'description' => __( 'Extend your store functionality with 8 ultra-performant features like product comparisons, variation swatches, wishlist, and more.', 'jaxon' ),
				'icon'        => $this->get_sdk_uri() . 'assets/images/sparks.png',
				'condition'   => class_exists( 'WooCommerce', false ),
			],
			'templates-patterns-collection'       => [
				'name'        => 'Templates Cloud',
				'description' => __( 'Design, save, and revisit your templates anytime with your personal vault on Templates Cloud.', 'jaxon' ),
			],
		];
